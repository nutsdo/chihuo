			...
			<div class="container-fluid">
				...
				<div class="widget-body">
                    <p>
                       ...
                       <a class="btn btn-warning" id="btn-add" href="{{asset('admin/group/add')}}"><i class="icon-plus icon-white"></i>添加</a>
                        ...
                        <div class="widget-body">
                            ...
                            @foreach($groups as $group)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$group->id}}</td>
                                    <td class="hidden-phone"><a href="">{{$group->name}}</a></td>
                                    <td class="hidden-phone">
                                    	<a class="btn btn-primary" href="{{asset('admin/group/edit/'.$group->id)}}"><i class="icon-pencil icon-white"></i> 修改</a>
                       					<a class="btn btn-danger" href="{{asset('admin/group/delete/'.$group->id)}}"><i class="icon-remove icon-white"></i> 删除</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
