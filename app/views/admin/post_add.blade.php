	                     ...
	                     <div class="widget-body form">
	                        ...
	                        {{ Form::open(array(
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6  popovers" id="author" name="author" data-trigger="hover" data-content="请输入文章作者" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append date date-picker" data-date="9-23-2014" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                            <input class=" m-ctrl-medium date-picker" id="post_time" name="post_time" size="16" type="text" value="9-23-2014" /><span class="add-on"><i class="icon-calendar"></i></span>
                                        </div>
                                    </div>
                               </div>
                               <div class="control-group">
	                           ...
	                           <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span12" id="ueditor" name="content" rows="6"></textarea>
                                    </div>
                               </div>
                               <div class="control-group">
	                              <label class="control-label">标签</label>
	                              <div class="controls">
	                                 <input id="tags_1" type="text" name="tags" class="m-wra tags" value="石家庄,吃货,小队,标签" />
	                              </div>
	                           </div>
