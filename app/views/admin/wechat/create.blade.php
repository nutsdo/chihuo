	                     ...
	                     <div class="widget-body form">
	                        ...
	                        {{ Form::open(array(
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 popovers" id="name" name="name" data-trigger="hover" data-content="请输入菜单名称。" data-original-title="提示" />
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                              	<input type="text" class="span6  popovers" id="key" name="key" data-trigger="hover" data-content="关键字(关键字和URL任选其一)" data-original-title="提示" />
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                              	<input type="text" class="span6  popovers" id="url" name="url" data-trigger="hover" data-content="URL(关键字和URL任选其一)" data-original-title="提示" />
