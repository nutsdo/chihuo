	                     ...
	                     <div class="widget-body form">
	                        ...
	                        {{ Form::open(array(
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6  popovers" id="title" name="title" data-trigger="hover" data-content="请输入文章作者" data-original-title="提示" />
	                              </div>
	                           </div>
                               <div class="control-group">
                                ...
                                <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6  popovers" id="url" name="url" data-trigger="hover" data-content="请输入微信文章链接" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
	                              <label class="control-label">排序</label>
	                              <div class="controls">
	                                 <input type="text" class="span6  popovers" id="sort" name="sort" data-trigger="hover" data-content="请输入微信文章链接" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <label class="radio">
		                                 <div class="radio" id="uniform-undefined">
		                                 	<span class="checked"><input type="radio" name="is_top" value="1" style="opacity: 0;"></span>
		                                 </div>
	                                 是
	                                 </label>
	                                 <label class="radio">
	                                 	<div class="radio" id="uniform-undefined">
	                                 		<span class=""><input type="radio" name="is_top" value="0" checked="" style="opacity: 0;"></span>
	                                 	</div>
	                                 否
	                                 </label>  
	                              </div>
