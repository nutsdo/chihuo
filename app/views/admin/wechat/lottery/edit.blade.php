	                  ...
	                  <div class="widget">
	                     ...
	                     <div class="widget-body form">
	                        ...
	                        {{ Form::open(array(
	                         ...
	                         {{Form::hidden('id',$lottery->id)}}
	                           <div class="control-group">
	                              <label class="control-label">标题</label>
	                              <div class="controls">
	                                 <input type="text" class="span6 popovers" id="title" name="title" value="{{$lottery->title}}" data-trigger="hover" data-content="请输入文章标题" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
	                              <label class="control-label">关键词</label>
	                              <div class="controls">
	                                 <input type="text" class="span6  popovers" id="keyword" name="keyword" value="{{$lottery->keyword}}" data-trigger="hover" data-content="请输入关键词" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append date date-picker" data-date="9-23-2014" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                            <input class=" m-ctrl-medium date-picker" id="start_time" name="start_time" size="16" type="text" value="{{date('d/m/y',$lottery->start_time)}}" /><span class="add-on"><i class="icon-calendar"></i></span>
                                        </div>
                                    </div>
                               </div>
                               <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append date date-picker" data-date="9-23-2014" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                            <input class=" m-ctrl-medium date-picker" id="end_time" name="end_time" size="16" type="text" value="{{date('d/m/y',$lottery->end_time)}}" /><span class="add-on"><i class="icon-calendar"></i></span>
                                        </div>
                                    </div>
                               </div>
                               <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="{{asset($lottery->picurl)}}" alt="" />
                                            </div>
	                           ...
	                           <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span12" id="ueditor" name="description" rows="6">{{$lottery->description}}</textarea>
                                    </div>
                               </div>
                               <div class="control-group">
                                    <label class="control-label">活动规则</label>
                                    <div class="controls">
                                        <textarea class="span12" id="rules" name="rules" rows="6">{{$lottery->rules}}</textarea>
                                    </div>
                               </div>
                               <div class="control-group">
	                              <label class="control-label">每日抽奖次数</label>
	                              <div class="controls">
	                                 <input type="text" class="span6 popovers" id="numbers" name="numbers" value="{{$lottery->numbers}}" data-trigger="hover" data-content="请输入每日抽奖次数" data-original-title="提示" />
	                              </div>
	                           </div>
