			...
			<div class="container-fluid">
				...
				<div class="widget-body">
                    <p>
                       ...
                       <a class="btn btn-warning" id="btn-add" href="{{route('prize-lottery-add',$lottery->id)}}"><i class="icon-plus icon-white"></i>添加</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>{{$lottery->title}}奖品列表</h4>
                            <span class="tools">
