		...
		<div id="main-content">
			...
			<div class="container-fluid">
				...
				<div class="widget-body">
                    <p>
                       <a class="btn" href="{{route('prize-list')}}"><i class="icon-eye-open"></i> 查看奖品库</a>
                       <a class="btn btn-warning" id="btn-add" href="{{route('lottery-create')}}"><i class="icon-plus icon-white"></i>添加</a>
                        ...
                        <div class="widget-body">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$lottery->id}}</td>
                                    <td class="hidden-phone"><a href="##">{{$lottery->title}}</a></td>
                                    <td class="hidden-phone"><a href="##">{{$lottery->keyword}}</a></td>
                                    <td class="hidden-phone">{{date('Y-m-d',$lottery->start_time)}}</td>
                                    <td class="center hidden-phone">{{date('Y-m-d',$lottery->end_time)}}</td>
                                    <td class="hidden-phone">
                                    	<a class="btn btn-success" href="{{route('lottery-show',$lottery->id)}}"><i class="icon-ok icon-white"></i> 预览</a>
                                    	<a class="btn btn-primary" href="{{route('lottery-edit',$lottery->id)}}"><i class="icon-pencil icon-white"></i> 修改</a>
                                    	<a class="btn btn-primary" href="{{route('lottery-prize',$lottery->id)}}"><i class="icon-pencil icon-white"></i> 设置奖品</a>
                                    	<a class="btn btn-primary" href="{{route('lottery-winner',$lottery->id)}}"><i class="icon-pencil icon-white"></i> 查看中奖</a>
	                       				<a href="{{route('lottery-destroy',$lottery->id)}}" role="button" class="btn btn-danger" data-toggle="modal" onclick="return confirm('确定要删除么')"><i class="icon-remove icon-white"></i>删除</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
