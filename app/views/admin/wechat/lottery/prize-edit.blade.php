	               ...
	               <div class="span12">
	                  ...
	                  <div class="widget">
	                     <div class="widget-title">
	                        <h4><i class="icon-reorder"></i>修改奖品信息</h4>
	                        <span class="tools">
	                     ...
	                     <div class="widget-body form">
	                        ...
	                        {{ Form::open(array(
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 popovers" id="name" name="name" value="{{$prize->name}}" data-trigger="hover" data-content="请输入文章标题" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6  popovers" id="prize_sn" name="prize_sn" value="{{$prize->prize_sn}}" data-trigger="hover" data-content="请输入关键词" data-original-title="提示" />
	                              </div>
	                           </div>
                               <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="{{asset($prize->prize_pic)}}" alt="" />
                                            </div>
	                           ...
	                           <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span12" id="ueditor" name="description" rows="6">{{$prize->description}}</textarea>
                                    </div>
                               </div>
                               <div class="control-group">
	                              <label class="control-label">奖品数量</label>
	                              <div class="controls">
	                                 <input type="text" class="span6 popovers" id="amount" name="amount" value="{{$prize->amount}}" data-trigger="hover" data-content="请输入每日抽奖次数" data-original-title="提示" />
	                              </div>
	                           </div>
