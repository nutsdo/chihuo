...
@section('style')
	...
	{{ HTML::style('packages/admin/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css') }}
	{{ HTML::style('packages/admin/assets/jqvmap/jqvmap/jqvmap.css') }}
@stop
@section('content')
		<!-- BEGIN PAGE -->
		<div id="main-content">
...
@section('script1')	
	...
	{{ HTML::script('packages/admin/js/jquery.cookie.js')}}
@stop
@section('script2')
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/jquery.vmap.js')}}
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/maps/jquery.vmap.russia.js')}}
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/maps/jquery.vmap.world.js')}}
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/maps/jquery.vmap.europe.js')}}
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/maps/jquery.vmap.germany.js')}}
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/maps/jquery.vmap.usa.js')}}
	{{ HTML::script('packages/admin/assets/jqvmap/jqvmap/data/jquery.vmap.sampledata.js')}}
	{{ HTML::script('packages/admin/assets/jquery-knob/js/jquery.knob.js')}}
	{{ HTML::script('packages/admin/assets/flot/jquery.flot.js')}}
	{{ HTML::script('packages/admin/assets/flot/jquery.flot.resize.js')}}

	{{ HTML::script('packages/admin/assets/flot/jquery.flot.pie.js')}}
    {{ HTML::script('packages/admin/assets/flot/jquery.flot.stack.js')}}
    {{ HTML::script('packages/admin/assets/flot/jquery.flot.crosshair.js')}}

    {{ HTML::script('packages/admin/js/jquery.peity.min.js')}}
