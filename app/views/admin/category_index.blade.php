			...
			<div class="container-fluid">
				...
				<div class="widget-body">
                    <p>
                       ...
                       <a class="btn btn-warning" id="btn-add" href="{{asset('admin/category/create')}}"><i class="icon-plus icon-white"></i>添加</a>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="hidden-phone">
                                    	<a class="btn btn-primary" href="{{asset('admin/category/edit/'.$cate->id)}}"><i class="icon-pencil icon-white"></i> 修改</a>
	                       				<a href="{{asset('admin/user/delete/'.$cate->id)}}" role="button" class="btn btn-danger" data-toggle="modal" onclick="return confirm('确定要删除么')"><i class="icon-remove icon-white"></i>删除</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
