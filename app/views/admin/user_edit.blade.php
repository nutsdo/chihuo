	                     ...
	                     <div class="widget-body form">
	                        ...
	                        {{ Form::open(array(
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 popovers" id="username" name="username" data-trigger="hover" value="{{$user->username}}" data-content="请输入用户名，必须为英文、数字、下划线。" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
	                              <label class="control-label">密码</label>
	                              <div class="controls">
	                                 <input type="password" class="span6  popovers" id="password" name="password" data-trigger="hover" value="" data-content="请输入密码，6-16位。" data-original-title="提示" />
	                              </div>
	                           </div>
	                           <div class="control-group">
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <div class="input-prepend">
	                                    <span class="add-on">@</span><input id="email" type="email" value="{{$user->email}}" name="email" placeholder="邮箱地址" />
	                                 </div>
	                              </div>
	                           </div>
	                           <div class="control-group">
