...
<div class="center">
	...
	<div class="cen cen_1">
		...
		<div class="right">
			...
			<div id="fixpar">
				<div class="wx">
					<span>{{HTML::image('packages/style/images/wx.png',null,array('width'=>'194','height'=>'24'))}}</span>
					{{HTML::image('packages/style/images/weixina.jpg',null,array('width'=>'276','height'=>'290'))}}
					{{HTML::image('packages/style/images/xiaodui.png',null,array('width'=>'276','height'=>'30'))}}	
					
					<div class="find_us">				
						<div class="left">
							{{HTML::image('packages/style/images/wbz.png',null,array('width'=>'150','height'=>'18'))}}															
						</div>
						<div class="right">				
							<a href="###" class="a1">{{HTML::image('packages/style/images/qzxd.jpg',null,array('width'=>'78','height'=>'18'))}}</a>										
						</div>
						<div class="clear"></div>
						<div class="mtop20"></div>
						<div class="wbq">
							<iframe width="280" height="550" class="share_self"  frameborder="0" scrolling="no" src="http://widget.weibo.com/weiboshow/index.php?language=&width=280&height=550&fansRow=2&ptype=1&speed=0&skin=5&isTitle=0&noborder=0&isWeibo=1&isFans=1&uid=5235985683&verifier=d4b22b91&dpc=1"></iframe>
						</div>
					</div>										
				</div>
			</div>
